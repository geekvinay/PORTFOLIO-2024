...
const About = () => {
  return (
    <div className="w-full min-h-screen px-4 sm:px-6 md:px-10 lg:px-20 py-8 sm:py-12 md:py-16 grid grid-cols-1 lg:grid-cols-2 lg:items-center gap-12">
      ...
      <div className="h-fit flex flex-col justify-center bg-gradient-to-bl from-gray-50 via-gray-100 to-gray-50 p-6 sm:p-8 rounded-lg">
        <h3 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-gray-900 mb-6">How It's Going</h3>
        <p className="text-base sm:text-lg text-gray-800 leading-relaxed mb-4">
