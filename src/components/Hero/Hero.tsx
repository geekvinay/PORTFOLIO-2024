...
const Hero = () => {
  return (
    <section className='min-h-screen pt-[8rem] w-screen px-[10rem] flex flex-col items-center justify-center'>
      <AdvertBanner />

      <section className="hero-intro py-[6rem] w-full grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="hero-text flex flex-col justify-center">
          <h1 className="text-[2.5rem] font-bold text-gray-900 mb-4 leading-tight">
            Hi! 👋 My name is <span className="text-red-500 text-nowrap">VINAY KISHORE</span> and I am a software engineer.
          </h1>
        </div>
